...
function QuizComponents(props) {
    ...
    return <>
        <ToastContainer />
        {display && <div className='flex justify-center my-2'>
            <div className='w-full md:w-7/12 border rounded-[10px] flex justify-between '>
                ...
                <div className='w-6/12  '>
                    <div className='mx-2 my-4'>
                        <div className='flex flex-col'>
                            <p className='text-green-400 text-lg mb-1'>{props.createdAt}</p>
                            ...
                            <div className=' mt-1 flex items-center'>
                                ...
                                <p className='text-lg mx-3'><TbNumbers className="inline mx-1" />{props.totalScore} marks</p>
                            </div>
                        </div>
                    </div>
                </div>
                <div className='w-3/12 my-auto  '>
                    <Link href={`/${props._id}`}>
                        <button className='px-3 py-2 mx-2 text-white bg-green-600'>Analytics</button>
                    </Link>
                    <button onClick={() => deleteItem(props._id)} className='px-3 py-2 mx-2 text-white bg-red-600'>Delete</button>
                </div>
            </div>
        </div>}
    </>
